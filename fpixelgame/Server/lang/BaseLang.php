...
namespace fpixelgame\Server\lang;

use fpixelgame\Event\TextContainer;
use fpixelgame\Event\TranslationContainer;
...
class BaseLang {
	...
	public function __construct($lang, $path = null, $fallback = self::FALLBACK_LANGUAGE){
		...
		if($path === null){
			$path = \pocketmine\PATH . "src/fpixelgame/Server/lang/locale/";
		}
