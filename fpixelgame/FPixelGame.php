...
/*
Version: 1.0.0 For Minecraft PE 1.1.x
PHP:7.3
New API
*/
...
use fpixelgaem\API\Server\Binary;
use fpixelgame\API\Server\ServerLoad;
use fpixelgame\API\Server\ServerKiller;
use fpixelgame\API\Server\Terminal;
use fpixelgame\API\Server\Utils;

use fpixelgame\API\Server\Installer;


	const VERSION = "-FPixelGameCore";
	const API_VERSION = "3.0.0";
	const CODENAME = "FAP大法好";
