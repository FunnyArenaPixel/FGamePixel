...
class MainLogger extends \AttachableThreadedLogger {
	 ...
	 * @param string $name
	 */
	public function error($message, $name = "报错"){
	 ...
	 * @param string $name
	 */
	public function notice($message, $name = "提示"){
	 ...
	 * @param string $name
	 */
	public function debug($message, $name = "Bug修复"){
	...
	protected function send($message, $level, $prefix, $color){
		...
		if($thread === null){
			$threadName = "FillAmeaPixel FPixelGame Start";
