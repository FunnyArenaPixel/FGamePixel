...
namespace fpixelgame\API\Server;
...
class InstallerLang {
	...
	public function __construct($lang = ""){
		if(file_exists(\pocketmine\PATH . "src/fpixelgame/Server/lang/Installer/" . $lang . ".ini")){
			$this->lang = $lang;
			$this->langfile = \pocketmine\PATH . "src/fpixelgame/Server/Installer/" . $lang . ".ini";
		}else{
			$files = [];
			foreach(new \DirectoryIterator(\pocketmine\PATH . "src/fpixelgame/Server/lang/Installer/") as $file){
			...
			if(count($files) > 0){
				...
				$this->langfile = \pocketmine\PATH . "src/fpixelgame/Server/lang/Installer/" . $l . ".ini";
			}else{
				$this->lang = "en";
				$this->langfile = \pocketmine\PATH . "src/fpixelgame/Server/lang/Installer/eng.ini";
			}
		}

		$this->loadLang(\pocketmine\PATH . "src/fpixelgame/Server/lang/Installer/eng.ini", "eng");
		if($this->lang !== "en"){
